        ...
        <div className="max-w-screen-xl mx-auto">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0 flex justify-between items-center">
              ...
              <div className="flex space-x-6 sm:justify-center sm:mt-0 sm:hidden">
            ...
            <div className="grid grid-cols-3 gap-8 sm:gap-6 sm:grid-cols-3 px-5 mt-5">
              <div>
                ...
                <ul className="text-gray-400">
                  <li className="mb-4">
                    <Link
                      to="https://openai.com"
                      className="hover:underline text-sm md:text-md"
                    >
                      ChatGPT
                    </Link>
                  </li>
