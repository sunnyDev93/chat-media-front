...
// const classificationChainResult = classificationChain.invoke({
...
// const result1 = fullChain.invoke({ question: "how do I use Anthropic?" });
...
// const result2 = fullChain.invoke({ question: "how do I use LangChain?" });
...
// const result3 = fullChain.invoke({ question: "what is 2 + 2?" });
