...
const ChatFooter = () => {
  ...
  return (
    <div>
      ...
      <div className="flex space-x-6 sm:mt-0 ml-2 justify-center mb-5">
        <Link to="/">
          <svg
            className="h-5 w-5"
            role="img"
      ...
      <div className="w-1/2 mx-auto flex justify-center items-center mb-10">
        <Link
          to="/"
        ...
        <img
          ...
          alt="line"
          className="h-[1px] mr-5"
        />
        <span className="text-sm  sm:text-center text-gray-400 mr-5">
          © 2023 ChatMP3.ai
        </span>
